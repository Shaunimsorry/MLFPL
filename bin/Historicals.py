...
#print (slim19Fixtures.loc[(slim19Fixtures.team_a == 'Spurs') & (slim19Fixtures.team_h == "Everton")])
teama = 'Spurs'
teamb = 'Everton'

print ("2018 Season: ")
print (slim18Fixtures.loc[(slim18Fixtures.team_a == teama) & (slim18Fixtures.team_h == teamb)])
print (slim18Fixtures.loc[(slim18Fixtures.team_a == teamb) & (slim18Fixtures.team_h == teama)])

print ("2019 Season")
print (slim19Fixtures.loc[(slim19Fixtures.team_a == teama) & (slim19Fixtures.team_h == teamb)])
print (slim19Fixtures.loc[(slim19Fixtures.team_a == teamb) & (slim19Fixtures.team_h == teama)])
